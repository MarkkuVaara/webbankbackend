...
insert into messages (date, read, title, message, user_id) values ('01/07/2024', false, 'Tervetuloa', 'Tervetuloa, uusi asiakas. Olet kissa, joten et saa kaikkia niitä pankkitoimintoja käyttöösi joita haluaisit. Voit kuitenkin tehdä tilisiirtoja ja nostaa lainoja. Tervetuloa Monetarumiin!', 3);
